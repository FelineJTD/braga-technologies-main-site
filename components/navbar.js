    ...
    <>
      ...
      <nav id='nav' className='flex items-center justify-between w-full px-6 py-3 bg-white text-gray-600 bg-opacity-50 backdrop-blur sticky top-0 z-50 duration-200 selection:bg-primary selection:text-gray-50 h-[60px]'>
        ...
        <div className='justify-self-center items-center space-x-6 h-full hidden lg:flex'>
          <Link href='/'>
            <a className={`${currPage === 'home' ? 'text-primary underline underline-offset-4 decoration-[1.5px]' : 'un'} text-sm`}>Home</a>
          </Link>
          <Link href='/geodashboard'>
            <a className={`${currPage === 'geodashboard' ? 'text-primary underline underline-offset-4 decoration-[1.5px]' : 'un'} text-sm`}>GeoDashboard</a>
          </Link>
          <Link href='/works'>
            <a className={`${currPage === 'works' ? 'text-primary underline underline-offset-4 decoration-[1.5px]' : 'un'} text-sm`}>Works</a>
          </Link>
          <div className='relative h-full'>
            ...
            <div className='absolute -left-4 top-0 w-[calc(100%+32px)] min-h-[48px] max-h-[48px] hover:max-h-[10rem] duration-500 z-40 overflow-hidden flex flex-col'>
              <Link href='/company/culture'>
                <a className={`${currPage === 'company' ? 'text-primary underline underline-offset-4 decoration-[1.5px]' : 'un'} left-0 top-0 text-sm mt-[7px] mb-[25%] mx-4`}>Company</a>
              </Link>
          ...
          <Link href='/contact'>
            <a className={`${currPage === 'contact' ? 'text-primary underline underline-offset-4 decoration-[1.5px]' : 'un'} text-sm`}>Contact</a>
          </Link>
        </div>
        <div className='flex'>
