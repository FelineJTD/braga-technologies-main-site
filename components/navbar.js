...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* DESKTOP NAV */}
      <nav id='nav' className='flex items-center justify-between w-full px-6 py-3 bg-white text-gray-600 bg-opacity-75 backdrop-blur sticky top-0 z-50 duration-200'>
