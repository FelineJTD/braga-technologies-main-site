  ...
  return (
    <div>
      ...
      <main className='text-gray-900 w-full'>
        ...
        {/* 01 */}
        <section className='defaultPadding flex flex-col lg:grid lg:grid-cols-12'>
          ...
          <div className='flex flex-col space-y-1 col-span-6 md:grid grid-cols-2 px-0 lg:px-6 gap-6 mt-8'>
            {
              solutions.map((solution, index) => (
                <div key={index} className='flex flex-col space-y-2 w-full rounded-lg p-3 border-2 border-gray-200'>
                  ...
                  <div className='flex justify-between justify-self-end'>
                    <button className='border-black'>See Solution</button>
                    <p>{solution.type}</p>
                  </div>
                </div>
              ))
        ...
        {/* 02 */}
        <section className='bg-gray-900 text-white md:mx-6 rounded-2xl defaultPadding flex flex-col items-start lg:grid lg:grid-cols-12'>
