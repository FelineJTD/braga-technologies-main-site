...
export default function Works() {
  ...
  const data = {
    ...
    solution_desc:
      "“Geodashboard, allows us to create, update & publish maps faster, saving our valuable time, and giving better service.”",
    key_expertise: [
      "Project Management",
      "Data Collection",
    ...
    <div>
      ...
      <main className='text-gray-900 bg-gray-50 w-full -mt-[4.2rem]'>
        ...
        <section className='text-white rounded-b-2xl px-6 pb-10 pt-[7rem] xl:px-[10%] flex flex-col lg:grid lg:grid-cols-12 items-start gap-x-6 bg-cover bg-center bg-no-repeat'>
          {/* Image Background */}
          <div
            className='w-full h-screen absolute top-0 left-0 rounded-b-2xl z-0'
          ...
          <p className='col-span-11 mb-4 bold relative z-10'>
            Works / Case Study
          </p>
          <div className='col-start-2 col-span-4 relative z-10'>
            <p className='mb-3'>{data.title}</p>
            <h1 className='font-inter font-semibold text-[36px] md:text-[48px] [line-height:46px] md:[line-height:58px] mb-[5vh] lg:mb-0'>
              {data.headline}
            </h1>
          </div>
          ...
          <section className='col-start-2 col-span-10 relative w-full'>
            ...
            <div className='flex items-center justify-center w-full h-full absolute top-0 left-0 z-20'>
              <button className='buttonDark bg-white shadow-md'>
                Visit Project
              </button>
            </div>
          </section>
        ...
        <section className='whiteBG -mt-12'>
          ...
          <h6 className='text-xl col-span-4 mb-10'>
