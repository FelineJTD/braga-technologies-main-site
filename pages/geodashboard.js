    ...
    <div>
      ...
      <main className='text-gray-900 bg-gray-50 w-full'>
        ...
        <section className='whiteBG'>
          <h1 className='col-start-2 col-span-5 text-5xl'>
            Broaden Your Insight Through Maps.
          </h1>
          <p className='col-span-5 self-end'>
            Visualize spatial data, excercise spatial analysis, and gather
            valuable insights with Geo-Dashboard – from your browser.
          </p>
        ...
        <div className='md:h-[2500px]'>
          <section id='scroll-area' className='whiteBG md:sticky top-0'>
            ...
            <div className='col-span-4 z-10'>
              ...
              <h2>
                From <i>seeing</i> where, to understand why.
              </h2>
            </div>
            <p className='text-gray-600 lg:self-end col-start-7 col-span-4 z-10 mt-3'>
              Created with less time, easy to add data, interactive
              visualization and user friendly interface.
            </p>
            <div
              className='w-full col-start-2 col-span-10 border-t-[1px] border-gray-600 mt-5 mb-10 z-10'
              aria-hidden
            />
            ...
            <div className='hidden md:flex flex-col justify-end min-h-[50vh] h-full col-start-2 col-span-4 relative'>
              <h3 className='font-inter text-[13.5rem] [line-height:10rem] font-medium text-gray-100 absolute top-0 z-0'>
                {Data01[currIdx].num}
              </h3>
            ...
            {Data01.map((item, idx) => {
              return (
                <div
                  className='md:hidden flex flex-col justify-end min-h-[50vh] h-full col-start-2 col-span-4 relative'
                  key={idx}
                >
                  <div className='self-end relative z-10'>
        ...
        <section className='whiteBG'>
          ...
          <p className='bold col-span-3 lg:sticky top-20 mb-4 lg:-mb-20'>
            Customer Stories
          </p>
          <h6 className='text-xl col-start-9 col-span-4 row-start-1 lg:sticky top-20 mb-11 lg:-mb-36'>
          ...
          <div className='row-start-1 col-start-5 col-span-4'>
            <h3 className='mb-44'>
              Designed for discoveries. <br />A simply-powerful tool, made{" "}
              <u>for everyone to explore</u> location insights faster than ever.
            </h3>
            <div className='bg-gray-200 rounded-lg h-72 w-full' />
            <div
              className='border-t-[1px] border-gray-600 mt-10 -mb-4 w-full'
              aria-hidden
            />
          </div>
        </section>
              ...
              return (
                <div key={idx} className='w-full px-0.5'>
                  <img
                    ...
                    alt={item.client_logo_alt}
                    className='h-6'
                  />
                  <img
                    src={item.image_url}
                    alt='cover image'
                    className='w-full h-36 bg-gray-200 text-center my-6'
                  />
                  ...
                  <div className='md:flex justify-between text-gray-800'>
                    <p className='text-sm mb-3 md:mb-0'>
                      {item.source_name}, <br /> {item.source_title}
                    </p>
