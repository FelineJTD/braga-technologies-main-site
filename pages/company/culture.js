    ...
    <div>
      ...
      <main className='text-gray-900 bg-gray-50 w-full'>
        ...
        <section ref={scrollAreaRef} className={`relative defaultGrid py-24 text-gray-50 bg-[#0E0D0D] ${isScrollArea? 'mt-0 mx-0 px-6 xl:px-[calc(10%+1.5rem)]' : 'mt-12 lg:mx-6 rounded-2xl px-6 lg:px-0 xl:px-[10%]'} duration-500`}>
          ...
          <p className='col-start-9 col-span-3 text-gray-200 mb-[24vw] text-sm relative z-10 mt-12'>More than our work, we are valuable as a person. As much as you do your best at work, we are committed at prioritizing and improving your well-being.</p>
          ...
          <p className='col-start-1 col-span-12 text-center text-sm bg-gradient-to-t from-[#0E0D0D] to-transparent pb-10 pt-24 relative -bottom-[6rem] z-10 text-gray-400'>“My main responsibility is not making a big company or big profit,<br />
