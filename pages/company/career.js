       ...
       <JobsSection jobs={Jobs} />
        ...
        <section className='whiteBGFullGrid mb-12'>
          ...
          { Testimonials.map((testimonial, index) => (
            <div key={index} className={`${index === currTestimonialIdx ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-12 motion-reduce:translate-y-0'} row-start-3 col-start-1 lg:col-start-2 col-span-4 relative z-10 mt-8 text-gray-50 lg:text-gray-800 duration-200 ease-in w-3/4`}>
