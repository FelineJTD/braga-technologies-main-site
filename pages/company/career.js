    ...
    <div>
      ...
      <main className='text-gray-900 bg-gray-50 w-full'>
        ...
        <section className='whiteBGFullGridSmPadding'>
          ...
          <p className='row-start-3 text-xs md:text-sm text-gray-600 col-start-3 lg:col-start-4 col-span-4 lg:col-span-3'>Be a creator. Own what you create, and help others to solve their problems.</p>
          <p className='row-start-4 lg:row-start-3 text-xs md:text-sm text-gray-600 col-start-3 lg:col-start-7 col-span-4 lg:col-span-3'>Interested in doing so? Find which team that suits you well.</p>
