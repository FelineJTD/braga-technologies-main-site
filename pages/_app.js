...
function MyApp({ Component, pageProps }) {
  ...
  return (
    <>
      ...
      {/* LOADING */}
      <div className={`${loading || !hasTimeElapsed? 'translate-y-0 duration-500' : '-translate-y-[100vh] duration-700'} fixed h-screen w-full bg-gray-50 z-50 flex flex-col items-center justify-center`}>
