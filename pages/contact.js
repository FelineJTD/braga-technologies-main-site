    ...
    <div>
      ...
      <main className='text-gray-900 bg-gray-50 w-full'>
        ...
        <section className='whiteBG'>
          ...
          <p className='row-start-3 col-start-2 col-span-2'>Contact Us</p>
          ...
          <div className='md:col-start-4 md:col-span-6 md:grid md:grid-cols-4 md:gap-2 flex space-x-2 overflow-auto'>
            {/* TYPES */}
            ...
            {/* FORM */}
            <form className='col-start-1 col-span-4 grid grid-cols-4 gap-3'>
        ...
        <section className='px-6 py-14 lg:px-[10%] h-screen bg-cover bg-center bg-no-repeat flex flex-col md:flex-row items-end justify-end' style={{backgroundImage: `url(${lastSectionImage})`}}>
          <div className='w-full md:w-1/2 md:mb-4 flex md:flex-col items-end'>
            ...
            <div className='flex lg:flex-row flex-col lg:space-x-4 bg-gray-50 rounded-2xl p-6'>
              <p className='bold mb-4'>01.</p>
              <div>
                <p className='mb-4 bold'>Visit us at</p>
                <h3 className='mb-4 w-2/3'>Braga Technologies Bandung Office</h3>
                <div className='flex w-full justify-between'>
                  <p className='text-sm'>Jl. Cilaki No. 23<br />Bandung, Indonesia.<br />40114</p>
                  <button className='buttonLight w-2/3 lg:w-auto whitespace-nowrap mr-3'>See on Map &gt;</button>
                </div>
              </div>
            </div>
